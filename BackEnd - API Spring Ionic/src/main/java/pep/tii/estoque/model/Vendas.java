...
@NamedQueries({
    ...
    @NamedQuery(name = "Vendas.findByCodigoVenda", query = "SELECT v FROM Vendas v WHERE v.codigo_venda = :codigo_venda"),
    ...
    @NamedQuery(name = "Vendas.itensPorPeriodos", query = "SELECT pv FROM Produtovenda pv WHERE pv.codigo_venda.data_venda BETWEEN :datainicio AND :datafim ORDER BY pv.codigo_venda.codigo_venda"),
...
public class Vendas implements Serializable {
    ...
    private Convenio codigo_convenio;
    ...
    public Vendas(Integer codigo_venda, Date data_venda, String forma_pagamento, Double valor_venda, Caixa codigo_caixa, Convenio codigo_convenio) {
    ...
    public Convenio getCodigo_convenio() {
        return codigo_convenio;
    }

    public void setCodigo_convenio(Convenio codigo_convenio) {
        this.codigo_convenio = codigo_convenio;
    }
